...
func (stmt *bsqlStmt) NumInput() int {
	return stmt.paramCount
}

func (stmt *bsqlStmt) ColumnConverter(idx int) driver.ValueConverter {
	return converter{}
}

func (stmt *bsqlStmt) CheckNamedValue(nv *driver.NamedValue) (err error) {
...
func (stmt *bsqlStmt) Query(args []driver.Value) (driver.Rows, error) {

...
// static interface implementation checks of bsqlConn
var (
	_ driver.ConnBeginTx        = &bsqlConn{}
	_ driver.ConnPrepareContext = &bsqlConn{}
	_ driver.ExecerContext      = &bsqlConn{}
	_ driver.Pinger             = &bsqlConn{}
	_ driver.QueryerContext     = &bsqlConn{}
)

// static interface implementation checks of bsqlStmt
var (
	_ driver.StmtExecContext  = &bsqlStmt{}
	_ driver.StmtQueryContext = &bsqlStmt{}
)
...
func TestContextBeginReadOnly(t *testing.T) {
	runTests(t, dsn, func(dbt *DBTest) {
		...
		if _, ok := err.(*BSQLError); !ok {
			dbt.Errorf("expected BSQLError, got %v", err)
		}
...
var _ driver.DriverContext = &MDBDriver{}
